...
var t = cc.SubdomainName.BauCuaLiveBW;
return cc.ServerConnector.getInstance().sendRequest(t, "api/BauCuaLiveBW/GetPlayersNotInGame", function(t) {
var i = JSON.parse(t);
...
cc.XXLiveBGPopupController.getInstance().createHelpView();
cc.XXLiveBGController.getInstance().HideAndShowLive();
},
onClickHistory: function() {
this.onClickHideMenu();
cc.XXLiveBGPopupController.getInstance().createHistoryView();
cc.XXLiveBGController.getInstance().HideAndShowLive();
},
...
cc.BalanceController.getInstance().updateBalance(e.A[1]);
...
cc.BalanceController.getInstance().updateBalance(e.A[0].Balance);
...
e.prototype.execute = function(e) {
var t = cc.SubdomainName.BauCuaLiveBW;
return cc.ServerConnector.getInstance().sendRequest(t, "api/BauCuaLiveBW/GetHistory?top=50", function(t) {
var i = JSON.parse(t);
...
e.prototype.execute = function(e) {
var t = cc.SubdomainName.BauCuaLiveBW;
return cc.ServerConnector.getInstance().sendRequest(t, "api/BauCuaLiveBW/GetSoiCau", function(t) {
var i = JSON.parse(t);
...
e.prototype.execute = function(e) {
var t = cc.SubdomainName.BauCuaLiveBW;
return cc.ServerConnector.getInstance().sendRequest(t, "api/BauCuaLiveBW/GetBigWinner", function(t) {
var i = JSON.parse(t);
